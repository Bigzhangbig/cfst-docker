...
## 阶段 4：文档同步与最终交付 [checkpoint: 70e4232]
- [x] 任务：更新 README.md 及项目文档。 (fe82558)
    - [x] 更新镜像下载路径为 `ghcr.io` 地址。
    - [x] 说明版本号命名规则（主版本同步 + 子版本构建次数）。
- [x] 任务：生成拉取测试命令。 (fe82558)
    - [x] 为用户提供明确的 `docker pull` 和 `docker run` 命令示例，用于验证远程镜像的可用性。
- [x] 任务：Conductor - 用户手动验证 '阶段 4：文档同步与最终交付' (70e4232)
